...
{
	public class CreateAmmoForHeroSniperSystem : IExecuteSystem
	{
		...
		public CreateAmmoForHeroSniperSystem(
			GameContext game,
		...
		public void Execute()
		{
			...
			{
				_ammoFactory
					.CreateAmmo(AmmoTypeId.LongRange, weapon.FirePositionTransform.position)
