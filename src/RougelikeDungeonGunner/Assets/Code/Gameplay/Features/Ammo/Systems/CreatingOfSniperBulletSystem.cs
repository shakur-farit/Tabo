...
{
	public class CreatingOfSniperBulletSystem : IExecuteSystem
	{
		...
		public CreatingOfSniperBulletSystem(
			GameContext game,
		...
		public void Execute()
		{
			...
			{
				_ammoFactory
					.CreateAmmo(AmmoTypeId.SniperBullet, 1, weapon.FirePositionTransform.position)
