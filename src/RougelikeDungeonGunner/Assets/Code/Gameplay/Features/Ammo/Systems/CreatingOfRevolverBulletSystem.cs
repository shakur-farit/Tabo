...
{
	public class CreatingOfRevolverBulletSystem : IExecuteSystem
	{
		...
		public CreatingOfRevolverBulletSystem(
			GameContext game,
		...
		public void Execute()
		{
			...
			{
				_ammoFactory
					.CreateAmmo(AmmoTypeId.RevolverBullet, 1, weapon.FirePositionTransform.position)
