...
{
  public class CreateFreezeBossSpecialEffectSystem : IExecuteSystem
  {
    ...
    public CreateFreezeBossSpecialEffectSystem(GameContext game, ISpecialEffectsFactory factory)
    {
      _game = game;
      _factory = factory;
    ...
    public void Execute()
    {
      foreach (GameEntity status in _statuses.GetEntities(_buffer))
      {
        ...
        GameEntity effect = _factory.CreateSpecialEffect(SpecialEffectTypeId.FreezeBoss, target.WorldPosition);
