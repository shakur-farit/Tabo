	...
	public class UpdateEnchantTimeLeftVisualSystem : IExecuteSystem
	{
		...
		public void Execute()
		{
			...
			foreach (GameEntity enchantHolder in _enchantHolders)
			{
				...
				{
					EnchantVisual enchantVisual = EnchantVisualByType(enchantHolder, enchant);
					enchantVisual.UpdateTimeLeftText(enchant.EnchantTimeLeft);
				}
			}
		}

		private static EnchantVisual EnchantVisualByType(GameEntity enchantHolder, GameEntity enchant) => 
