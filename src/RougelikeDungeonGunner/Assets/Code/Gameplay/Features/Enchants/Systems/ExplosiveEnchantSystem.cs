...
{
	public class ExplosiveEnchantSystem : IExecuteSystem
	{
		...
		public ExplosiveEnchantSystem(GameContext game)
		{
			...
			_ammo = game.GetGroup(GameMatcher
				.AllOf(
					GameMatcher.Ammo,
					GameMatcher.ProducerId)
				.NoneOf(GameMatcher.ExplosiveEnchant));
		}
