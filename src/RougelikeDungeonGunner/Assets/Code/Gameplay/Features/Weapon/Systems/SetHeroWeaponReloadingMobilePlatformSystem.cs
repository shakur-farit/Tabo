...
{
  public class SetHeroWeaponReloadingMobilePlatformSystem : IExecuteSystem
  {
    private readonly IWeaponReloadService _reloadService;
    private readonly IGroup<GameEntity> _weapons;
    private readonly List<GameEntity> _buffer = new(1);

    public SetHeroWeaponReloadingMobilePlatformSystem(GameContext game, IWeaponReloadService reloadService)
    {
