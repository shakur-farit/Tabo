...
{
	public class MarkDestructedHeroHeartHolderOnLevelProcessedSystem : IExecuteSystem
	{
		...
		public MarkDestructedHeroHeartHolderOnLevelProcessedSystem(GameContext game)
		{
