...
using Code.Meta.Features.Information.WeaponInformation.Factory;
...
namespace Code.Meta.Features.Information.WeaponInformation.Behaviours
{
	public class WeaponStatsUIHolder : MonoBehaviour
	{
		...
		private IWeaponStatUIEntryFactory _statUIEntryFactory;
		private IWeaponStatsProvider _statsProvider;
		private IWeaponEffectsProvider _effectsProvider;

		[Inject]
		public void Constructor(
			IWeaponStatUIEntryFactory statUIEntryFactory,
