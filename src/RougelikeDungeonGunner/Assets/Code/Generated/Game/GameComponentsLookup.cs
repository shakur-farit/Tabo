...
public static class GameComponentsLookup {
    ...
    public const int NewCollectedEnchant = 51;
    ...
    public const int MaxWeaponEnchantsCount = 127;
    public const int MinPelletsSpreadAngle = 128;
    public const int MultiPellet = 129;
    public const int Pistol = 130;
    public const int PlasmaGun = 131;
    public const int Precharged = 132;
    public const int PrechargeTime = 133;
    public const int PrechargeTimeLeft = 134;
    public const int ReadyToShoot = 135;
    public const int Reloading = 136;
    public const int ReloadTime = 137;
    public const int ReloadTimeLeft = 138;
    public const int Revolver = 139;
    public const int RocketLauncher = 140;
    public const int Shooting = 141;
    public const int Shot = 142;
    public const int Shotgun = 143;
    public const int Sniper = 144;
