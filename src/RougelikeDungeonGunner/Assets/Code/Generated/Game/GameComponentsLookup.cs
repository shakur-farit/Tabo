...
public static class GameComponentsLookup {
    ...
    public const int HeartHolder = 60;
    public const int Hero = 61;
    public const int HeroAnimator = 62;
    public const int HeroTypeId = 63;
    public const int TheGeneral = 64;
    public const int Unweaponed = 65;
    public const int Weaponed = 66;
    public const int EnemiesInLevelCount = 67;
    public const int EnemiesInLevelCountCalculated = 68;
    public const int EnemyWave = 69;
    public const int EnemyWaves = 70;
    public const int EnvironmentSetupAvailable = 71;
    public const int EnvironmentSetup = 72;
    public const int FinishingTime = 73;
    public const int FinishingTimeLeft = 74;
    public const int Level = 75;
    public const int LevelTypeId = 76;
    public const int SpawnedEnemyWaves = 77;
    public const int StartingTime = 78;
    public const int StartingTimeLeft = 79;
    public const int TimeBetweenWaves = 80;
    public const int TimeBetweenWavesLeft = 81;
    public const int CurrentHp = 82;
    public const int Dead = 83;
    public const int MaxHp = 84;
    public const int ProcessingDeath = 85;
    public const int Coins = 86;
    public const int CoinsHolder = 87;
    public const int Collected = 88;
    public const int LootTypeId = 89;
    public const int PickupRadius = 90;
    public const int Pullable = 91;
    public const int Pulling = 92;
    public const int Direction = 93;
    public const int MovementAvailable = 94;
    public const int Moving = 95;
    public const int Speed = 96;
    public const int Affected = 97;
    public const int Applied = 98;
    public const int ApplierStatusLink = 99;
    public const int Flame = 100;
    public const int Freeze = 101;
    public const int Period = 102;
    public const int Poison = 103;
    public const int Status = 104;
    public const int StatusDuration = 105;
    public const int StatusTimeLeft = 106;
    public const int StatusTypeId = 107;
    public const int TimeSinceLastTick = 108;
    public const int Unapplied = 109;
    public const int CollectTargetsContinuously = 110;
    ...
    public const int AutomaticPistol = 118;
    public const int NewWeaponTypeId = 119;
    public const int WeaponChangeable = 120;
    public const int WeaponChangeRequested = 121;
    public const int ClosestTargetPosition = 122;
    public const int CurrentAmmoCount = 123;
    public const int EffectSetups = 124;
    public const int FirePositionTransform = 125;
    public const int InfinityAmmo = 126;
    public const int LaserBlaster = 127;
    public const int Machinegun = 128;
    public const int MagazineNotEmpty = 129;
    public const int MagazineSize = 130;
    public const int MaxPelletsSpreadAngle = 131;
    public const int MaxWeaponEnchantsCount = 132;
    public const int MinPelletsSpreadAngle = 133;
    public const int MultiPellet = 134;
    public const int Pistol = 135;
    public const int PlasmaGun = 136;
    public const int Precharged = 137;
    public const int PrechargeTime = 138;
    public const int PrechargeTimeLeft = 139;
    public const int ReadyToShoot = 140;
    public const int Reloading = 141;
    public const int ReloadingAnimator = 142;
    public const int ReloadTime = 143;
    public const int ReloadTimeLeft = 144;
    public const int Revolver = 145;
    public const int RocketLauncher = 146;
    public const int Shooting = 147;
    public const int Shot = 148;
    public const int Shotgun = 149;
    public const int Sniper = 150;
    public const int StatusSetups = 151;
    public const int Weapon = 152;
    public const int WeaponEnchants = 153;
    public const int WeaponHolder = 154;
