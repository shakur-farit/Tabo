...
public static class GameComponentsLookup {
    ...
    public const int AmmoCountInPattern = 19;
    public const int AmmoPatternTypeId = 20;
    ...
    public const int PatternRadius = 25;
    ...
    public const int MinDistanceForRepath = 30;
    public const int Path = 31;
    public const int Pathfinder = 32;
    public const int PathfinderAvailable = 33;
    public const int PathfinderInitialized = 34;
    public const int PathfindingIntervalTimer = 35;
    public const int PathfindingTimerLeft = 36;
    public const int PathfindingTimerUp = 37;
    ...
    public const int CollisionTilemap = 44;
    public const int Dungeon = 45;
    public const int DungeonAvailable = 46;
    public const int DungeonTypeId = 47;
    public const int HeroStartPosition = 48;
    public const int ValidPositions = 49;
    public const int ValidSprite = 50;
    ...
    public const int Enchant = 57;
    public const int EnchantAlreadyHeld = 58;
    public const int EnchantDuration = 59;
    public const int EnchantTimeLeft = 60;
    public const int EnchantTypeId = 61;
    public const int EnchantUI = 62;
    public const int EnchantVisualEffect = 63;
    public const int FlameEnchant = 64;
    public const int FreezeEnchant = 65;
    public const int NewCollectedEnchant = 66;
    public const int PoisonEnchant = 67;
    public const int Enemy = 68;
    public const int EnemyAnimator = 69;
    public const int EnemyTypeId = 70;
    public const int Hedusa = 71;
    public const int LastTargetPosition = 72;
    public const int Orc = 73;
    public const int CurrentWeaponTypeId = 74;
    public const int Hero = 75;
    public const int HeroAnimator = 76;
    public const int HeroAvailable = 77;
    public const int HeroTypeId = 78;
    public const int TheGeneral = 79;
    public const int TheScientist = 80;
    public const int TheThief = 81;
    public const int Unweaponed = 82;
    public const int Weaponed = 83;
    public const int DungeonTypeOnLevel = 84;
    public const int EnemiesInLevelCount = 85;
    public const int EnemiesInLevelCountCalculated = 86;
    public const int EnemyWave = 87;
    public const int EnemyWaves = 88;
    public const int FinishingTime = 89;
    public const int FinishingTimeLeft = 90;
    public const int HeroSafeZoneRadius = 91;
    public const int Level = 92;
    public const int LevelTypeId = 93;
    public const int SpawnedEnemyWaves = 94;
    public const int StartingTime = 95;
    public const int StartingTimeLeft = 96;
    public const int StartingTimeUp = 97;
    public const int CurrentHp = 98;
    public const int Dead = 99;
    public const int MaxHp = 100;
    public const int ProcessingDeath = 101;
    public const int Coins = 102;
    public const int Collected = 103;
    public const int LootTypeId = 104;
    public const int PickupRadius = 105;
    public const int Pullable = 106;
    public const int Pulling = 107;
    public const int Direction = 108;
    public const int MovementAvailable = 109;
    public const int Moving = 110;
    public const int Speed = 111;
    public const int Affected = 112;
    public const int Applied = 113;
    public const int ApplierStatusLink = 114;
    public const int Flame = 115;
    public const int Freeze = 116;
    public const int Period = 117;
    public const int Poison = 118;
    public const int Status = 119;
    public const int StatusDuration = 120;
    public const int StatusTimeLeft = 121;
    public const int StatusTypeId = 122;
    public const int TimeSinceLastTick = 123;
    public const int Unapplied = 124;
    public const int BoxCastHeight = 125;
    public const int BoxCastWidth = 126;
    public const int CastStartPositionTransform = 127;
    public const int CollectTargetsContinuously = 128;
    public const int CollectTargetsInterval = 129;
    public const int CollectTargetsTimer = 130;
    public const int CollisionInFront = 131;
    public const int ForwardCastDistance = 132;
    public const int ProcessedTargets = 133;
    public const int Radius = 134;
    public const int ReadyToCollectTargets = 135;
    public const int TargetLayerMask = 136;
    public const int TargetsBuffer = 137;
    public const int ClosestTargetPosition = 138;
    public const int CurrentAmmoCount = 139;
    public const int EffectSetups = 140;
    public const int EnemyPistol = 141;
    public const int EnemyWeapon = 142;
    public const int FirePositionTransform = 143;
    public const int HeroAutomaticPistol = 144;
    public const int HeroLaserBlaster = 145;
    public const int HeroMachinegun = 146;
    public const int HeroPistol = 147;
    public const int HeroPlasmaGun = 148;
    public const int HeroRevolver = 149;
    public const int HeroRocketLauncher = 150;
    public const int HeroShotgun = 151;
    public const int HeroSniper = 152;
    public const int HeroWeapon = 153;
    public const int InfinityAmmo = 154;
    public const int MagazineNotEmpty = 155;
    public const int MagazineSize = 156;
    public const int MaxPelletsDeviation = 157;
    public const int MaxWeaponEnchantsCount = 158;
    public const int MinPelletsDeviation = 159;
    public const int MultiPellet = 160;
    public const int Pierce = 161;
    public const int Precharged = 162;
    public const int PrechargeTime = 163;
    public const int PrechargeTimeLeft = 164;
    public const int ReadyToShoot = 165;
    public const int Reloading = 166;
    public const int ReloadTime = 167;
    public const int ReloadTimeLeft = 168;
    public const int Shooting = 169;
    public const int Shot = 170;
    public const int StatusSetups = 171;
    public const int Weapon = 172;
    public const int WeaponEnchants = 173;
    public const int WeaponOwnerId = 174;
    public const int WeaponOwnerTypeId = 175;
    public const int WeaponRotationAngle = 176;
    public const int WeaponRotationPointTransform = 177;
    public const int WeaponTypeId = 178;
    public const int AmmoHolder = 179;
    public const int CoinsHolder = 180;
    public const int EnchantHolder = 181;
    public const int HeartHolder = 182;
    public const int ReloadingAnimator = 183;
    public const int TimerHolder = 184;
    public const int WeaponHolder = 185;
    ...
    public static readonly System.Type[] componentTypes = {
        ...
        typeof(Code.Gameplay.Features.Ammo.AmmoCountInPattern),
        typeof(Code.Gameplay.Features.Ammo.AmmoPatternTypeIdComponent),
        ...
        typeof(Code.Gameplay.Features.Ammo.PatternRadius),
