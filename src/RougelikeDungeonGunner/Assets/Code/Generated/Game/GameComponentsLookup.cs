...
public static class GameComponentsLookup {
    ...
    public const int EnemyBullet = 22;
    public const int LaserBolt = 23;
    public const int LightBullet = 24;
    public const int LongRangeBullet = 25;
    public const int RifleBullet = 26;
    public const int RocketMissile = 27;
    public const int ShotgunShell = 28;
    public const int SigilAmmo = 29;
    public const int TargetLimit = 30;
    public const int AddedInList = 31;
    public const int AmmoPattern = 32;
    public const int AmmoPatternId = 33;
    public const int AmmoPatternSetup = 34;
    public const int AmmoTransformsList = 35;
    public const int CirclePattern = 36;
    public const int PatternAmmoCount = 37;
    public const int PatternBranches = 38;
    public const int PatternCurrentAngle = 39;
    public const int PatternEmpty = 40;
    public const int PatternRadius = 41;
    public const int PatternRotateSpeed = 42;
    public const int SinglePattern = 43;
    public const int StarPattern = 44;
    public const int TrianglePattern = 45;
    public const int MinDistanceForRepath = 46;
    public const int Path = 47;
    public const int Pathfinder = 48;
    public const int PathfinderAvailable = 49;
    public const int PathfinderInitialized = 50;
    public const int PathfindingIntervalTimer = 51;
    public const int PathfindingTimerLeft = 52;
    public const int PathfindingTimerUp = 53;
    public const int Aura = 54;
    public const int AuraDuration = 55;
    public const int AuraDurationTimeLeft = 56;
    public const int AuraLayer = 57;
    public const int AuraLayerMask = 58;
    public const int AuraPeriod = 59;
    public const int AuraPeriodTimeLeft = 60;
    public const int AuraPeriodTimeUp = 61;
    public const int AuraRadius = 62;
    public const int AuraTypeId = 63;
    public const int HealingAura = 64;
    public const int HealingAuraApplied = 65;
    public const int RequestHealingAura = 66;
    public const int RequestShield = 67;
    public const int Shield = 68;
    public const int ShieldApplied = 69;
    ...
    public const int DestroyableCollectRadius = 81;
    public const int DestroyableTargetLayerMask = 82;
    public const int DestroyableTargetsBuffer = 83;
    ...
    public const int EnchantVisualEffect = 129;
    public const int ExplosiveEnchant = 130;
    public const int FlameEnchant = 131;
    public const int FreezeEnchant = 132;
    public const int NewCollectedEnchant = 133;
    public const int PoisonEnchant = 134;
    ...
    public const int Grimonk = 139;
    public const int Hedusa = 140;
    public const int LastTargetPosition = 141;
    public const int MudRock = 142;
    public const int Orc = 143;
    public const int Slime = 144;
    public const int Slizzard = 145;
    public const int CurrentWeaponTypeId = 146;
    public const int Hero = 147;
    public const int HeroAnimator = 148;
    public const int HeroAvailable = 149;
    public const int HeroTypeId = 150;
    public const int TheGeneral = 151;
    public const int TheScientist = 152;
    public const int TheThief = 153;
    public const int Unweaponed = 154;
    public const int Weaponed = 155;
    public const int DungeonTypeOnLevel = 156;
    public const int EnemiesInLevelCount = 157;
    public const int EnemiesInLevelCountCalculated = 158;
    public const int EnemyWave = 159;
    public const int EnemyWaves = 160;
    public const int HeroSafeZoneRadius = 161;
    public const int Level = 162;
    public const int LevelTypeId = 163;
    public const int SpawnedEnemyWaves = 164;
    public const int StartingTime = 165;
    public const int StartingTimeLeft = 166;
    public const int StartingTimeUp = 167;
    public const int CurrentHp = 168;
    public const int Dead = 169;
    public const int MaxHp = 170;
    public const int ProcessingDeath = 171;
    public const int Coins = 172;
    public const int Collected = 173;
    public const int ExcludedLoot = 174;
    public const int LootDropChance = 175;
    public const int LootTypeId = 176;
    public const int PickupRadius = 177;
    public const int Pullable = 178;
    public const int Pulling = 179;
    public const int Direction = 180;
    public const int FollowMovement = 181;
    public const int FollowMovementXAxisOffset = 182;
    public const int FollowMovementYAxisOffset = 183;
    public const int FollowTargetId = 184;
    public const int LinerMovement = 185;
    public const int MovementAvailable = 186;
    public const int Moving = 187;
    public const int OrbitalMovement = 188;
    public const int OrbitAngularSpeed = 189;
    public const int OrbitCenter = 190;
    public const int OrbitElapsedTime = 191;
    public const int OrbitInitialAngle = 192;
    public const int OrbitRadius = 193;
    public const int Speed = 194;
    public const int AudioClip = 195;
    public const int AudioSource = 196;
    public const int SoundEffect = 197;
    public const int SoundEffectTypeId = 198;
    public const int Volume = 199;
    public const int Rotating = 200;
    public const int RotationAngle = 201;
    public const int RotationAvailable = 202;
    public const int SpecialEffect = 203;
    public const int SpecialEffectTypeId = 204;
    public const int Affected = 205;
    public const int Applied = 206;
    public const int ApplierStatusLink = 207;
    public const int Explosive = 208;
    public const int Flame = 209;
    public const int Freeze = 210;
    public const int Period = 211;
    public const int Poison = 212;
    public const int Status = 213;
    public const int StatusDuration = 214;
    public const int StatusTimeLeft = 215;
    public const int StatusTypeId = 216;
    public const int TimeSinceLastTick = 217;
    public const int Unapplied = 218;
    public const int ClosestTarget = 219;
    public const int ClosestTargetPosition = 220;
    public const int CurrentAmmoCount = 221;
    public const int EffectSetups = 222;
    public const int EnemyCircleSigil = 223;
    public const int EnemyPistol = 224;
    public const int EnemyStarSigil = 225;
    public const int EnemyTriangleSigil = 226;
    public const int EnemyWeapon = 227;
    public const int FirePositionTransform = 228;
    public const int HeroAutomaticPistol = 229;
    public const int HeroCircleSigil = 230;
    public const int HeroLaserBlaster = 231;
    public const int HeroMachinegun = 232;
    public const int HeroPistol = 233;
    public const int HeroPlasmaGun = 234;
    public const int HeroRevolver = 235;
    public const int HeroRocketLauncher = 236;
    public const int HeroShotgun = 237;
    public const int HeroSniper = 238;
    public const int HeroStarSigil = 239;
    public const int HeroTriangleSigil = 240;
    public const int HeroWeapon = 241;
    public const int InfinityAmmo = 242;
    public const int MagazineNotEmpty = 243;
    public const int MagazineSize = 244;
    public const int MaxPelletsDeviation = 245;
    public const int MaxWeaponEnchantsCount = 246;
    public const int MinPelletsDeviation = 247;
    public const int MultiPellet = 248;
    public const int Pierce = 249;
    public const int Precharged = 250;
    public const int PrechargeTime = 251;
    public const int PrechargeTimeLeft = 252;
    public const int Precharging = 253;
    public const int ReadyToShoot = 254;
    public const int Reloading = 255;
    public const int ReloadSoundEffectTypeId = 256;
    public const int ReloadTime = 257;
    public const int ReloadTimeLeft = 258;
    public const int RotationPointTransform = 259;
    public const int Shooting = 260;
    public const int Shot = 261;
    public const int ShotSoundEffectTypeId = 262;
    public const int StatusSetups = 263;
    public const int Weapon = 264;
    public const int WeaponEnchants = 265;
    ...
    public static readonly System.Type[] componentTypes = {
        ...
        typeof(Code.Gameplay.Features.Music.AudioClipComponent),
        typeof(Code.Gameplay.Features.Music.AudioSourceComponent),
        typeof(Code.Gameplay.Features.Music.SoundEffect),
        typeof(Code.Gameplay.Features.Music.SoundEffectTypeIdComponent),
