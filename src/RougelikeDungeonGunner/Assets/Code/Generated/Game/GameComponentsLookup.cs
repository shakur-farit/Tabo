...
public static class GameComponentsLookup {
    ...
    public const int AmmoStatusVisualizer = 23;
    ...
    public const int ForwardCastDistance = 84;
    ...
    public const int TargetLayerMask = 89;
    public const int TargetsBuffer = 90;
    public const int Cooldown = 91;
    public const int CooldownLeft = 92;
    public const int CooldownUp = 93;
    public const int DestroyableAnimator = 94;
    public const int DestroyableItem = 95;
    public const int DestroyableItemTypeId = 96;
    public const int Destroyed = 97;
    public const int Destroying = 98;
    public const int Door = 99;
    public const int DoorAnimator = 100;
    public const int DoorPosition = 101;
    public const int DoorTypeId = 102;
    public const int Opened = 103;
    public const int CollisionTilemap = 104;
    public const int Dungeon = 105;
    public const int DungeonAvailable = 106;
    public const int DungeonTypeId = 107;
    public const int EnemySpawnValidPositions = 108;
    public const int EnemySpawnValidSprite = 109;
    public const int FloorDestroyableDecorationSprite = 110;
    public const int FloorDestroyableDecorationTilemap = 111;
    public const int FloorDestroyableItemValidPositions = 112;
    public const int HeroStartPosition = 113;
    public const int WallDestroyableDecorationSprite = 114;
    public const int WallDestroyableDecorationTilemap = 115;
    public const int WallDestroyableItemValidPositions = 116;
    public const int DamageEffect = 117;
    public const int Effect = 118;
    public const int EffectValue = 119;
    public const int HealEffect = 120;
    public const int ProducerId = 121;
    public const int TargetId = 122;
    public const int Enchant = 123;
    public const int EnchantAlreadyHeld = 124;
    public const int EnchantDuration = 125;
    public const int EnchantTimeLeft = 126;
    public const int EnchantTypeId = 127;
    public const int EnchantUI = 128;
    public const int ExplosiveEnchant = 129;
    public const int FlameEnchant = 130;
    public const int FreezeEnchant = 131;
    public const int NewCollectedEnchant = 132;
    public const int PoisonEnchant = 133;
    public const int Boss = 134;
    public const int Enemy = 135;
    public const int EnemyAnimator = 136;
    public const int EnemyHpBar = 137;
    public const int EnemyTargetSpriteRenderer = 138;
    public const int EnemyTypeId = 139;
    public const int LastTargetPosition = 140;
    public const int ScoreValue = 141;
    public const int AmmoPatternSpawnRequestSetting = 142;
    public const int EnemySpawnRequestSetting = 143;
    public const int MaxSpawnPerFrame = 144;
    public const int SpawnPosition = 145;
    public const int SpawnRequest = 146;
    public const int SpawnRequestSetting = 147;
    public const int SpawnRequestSettingTypeId = 148;
    public const int TargetDetected = 149;
    public const int TargetDetectingRadius = 150;
    public const int CurrentCoins = 151;
    public const int CurrentWeaponTypeId = 152;
    public const int Hero = 153;
    public const int HeroAnimator = 154;
    public const int HeroAvailable = 155;
    public const int HeroTypeId = 156;
    public const int TheGeneral = 157;
    public const int TheScientist = 158;
    public const int TheThief = 159;
    public const int Unweaponed = 160;
    public const int Weaponed = 161;
    public const int BossCount = 162;
    public const int BossesDefeated = 163;
    public const int BossWave = 164;
    public const int DungeonTypeOnLevel = 165;
    public const int EnemiesDefeated = 166;
    public const int EnemiesInLevelCount = 167;
    public const int EnemiesInLevelCountCalculated = 168;
    public const int EnemyWave = 169;
    public const int EnemyWaves = 170;
    public const int HeroSafeZoneRadius = 171;
    public const int Level = 172;
    public const int LevelTypeId = 173;
    public const int SpawnedEnemyWaves = 174;
    public const int StartingTime = 175;
    public const int StartingTimeLeft = 176;
    public const int StartingTimeUp = 177;
    public const int CurrentHp = 178;
    public const int Dead = 179;
    public const int MaxHp = 180;
    public const int ProcessingDeath = 181;
    public const int BulletLoot = 182;
    public const int Coins = 183;
    public const int Collected = 184;
    public const int ExcludedLoot = 185;
    public const int LootDropChance = 186;
    public const int LootTypeId = 187;
    public const int LootValue = 188;
    public const int MissileLoot = 189;
    public const int PickupRadius = 190;
    public const int Pullable = 191;
    public const int Pulling = 192;
    public const int Direction = 193;
    public const int FollowMovement = 194;
    public const int FollowMovementXAxisOffset = 195;
    public const int FollowMovementYAxisOffset = 196;
    public const int FollowTargetId = 197;
    public const int LinerMovement = 198;
    public const int MovementAvailable = 199;
    public const int Moving = 200;
    public const int OrbitalMovement = 201;
    public const int OrbitAngularSpeed = 202;
    public const int OrbitCenter = 203;
    public const int OrbitElapsedTime = 204;
    public const int OrbitInitialAngle = 205;
    public const int OrbitRadius = 206;
    public const int Speed = 207;
    public const int Rotating = 208;
    public const int RotationAngle = 209;
    public const int RotationAvailable = 210;
    public const int FollowerSpecialEffect = 211;
    public const int SpecialEffect = 212;
    public const int SpecialEffectApplied = 213;
    public const int SpecialEffectPositionOffset = 214;
    public const int SpecialEffectTypeId = 215;
    public const int Affected = 216;
    public const int Applied = 217;
    public const int ApplierStatusLink = 218;
    public const int Explosive = 219;
    public const int Flame = 220;
    public const int Freeze = 221;
    public const int Period = 222;
    public const int Poison = 223;
    public const int Status = 224;
    public const int StatusDuration = 225;
    public const int StatusTimeLeft = 226;
    public const int StatusTypeId = 227;
    public const int TimeSinceLastTick = 228;
    public const int Unapplied = 229;
    public const int BossMachinegun = 230;
    public const int BossPistol = 231;
    public const int ClosestTarget = 232;
    public const int ClosestTargetPosition = 233;
    public const int CurrentAmmoCount = 234;
    public const int CurrentAmmoCountInMagazine = 235;
    public const int EffectSetups = 236;
    public const int EnemyCircleSigil = 237;
    public const int EnemyMachinegun = 238;
    public const int EnemyPistol = 239;
    public const int EnemyStarSigil = 240;
    public const int EnemyTriangleSigil = 241;
    public const int EnemyWeapon = 242;
    public const int FirePositionTransform = 243;
    public const int HeroAutomaticPistol = 244;
    public const int HeroCircleSigil = 245;
    public const int HeroLaserBlaster = 246;
    public const int HeroMachinegun = 247;
    public const int HeroPistol = 248;
    public const int HeroPlasmaGun = 249;
    public const int HeroRevolver = 250;
    public const int HeroRocketLauncher = 251;
    public const int HeroShotgun = 252;
    public const int HeroSniper = 253;
    public const int HeroStarSigil = 254;
    public const int HeroTriangleSigil = 255;
    public const int HeroWeapon = 256;
    public const int InfinityAmmo = 257;
    public const int MagazineNotEmpty = 258;
    public const int MagazineSize = 259;
    public const int MaxAmmoCount = 260;
    public const int MaxPelletsDeviation = 261;
    public const int MaxWeaponEnchantsCount = 262;
    public const int MinPelletsDeviation = 263;
    public const int MultiPellet = 264;
    public const int Pierce = 265;
    public const int Precharged = 266;
    public const int PrechargeTime = 267;
    public const int PrechargeTimeLeft = 268;
    public const int Precharging = 269;
    public const int ReadyToShoot = 270;
    public const int Reloading = 271;
    public const int ReloadSoundEffectTypeId = 272;
    public const int ReloadTime = 273;
    public const int ReloadTimeLeft = 274;
    public const int RotationPointTransform = 275;
    public const int Shooting = 276;
    public const int Shot = 277;
    public const int ShotSoundEffectTypeId = 278;
    public const int StatusSetups = 279;
    public const int Weapon = 280;
    public const int WeaponEnchants = 281;
    public const int WeaponNotEmpty = 282;
    public const int WeaponOwnerId = 283;
    public const int WeaponOwnerTypeId = 284;
    public const int WeaponRotationAngle = 285;
    public const int WeaponTypeId = 286;
    public const int AmmoHolder = 287;
    public const int CoinsHolder = 288;
    public const int EnchantHolder = 289;
    public const int HeartHolder = 290;
    public const int HudAvailable = 291;
    public const int ReloadingAnimator = 292;
    public const int TimerHolder = 293;
    public const int WeaponHolder = 294;
    public const int AudioClip = 295;
    public const int AudioSource = 296;
    public const int SoundEffect = 297;
    public const int SoundEffectTypeId = 298;
    public const int Volume = 299;

    public const int TotalComponents = 300;
    ...
    public static readonly string[] componentNames = {
        ...
        "LastTargetPosition",
        "ScoreValue",
        "AmmoPatternSpawnRequestSetting",
        "EnemySpawnRequestSetting",
        "MaxSpawnPerFrame",
        "SpawnPosition",
        "SpawnRequest",
        "SpawnRequestSetting",
        "SpawnRequestSettingTypeId",
        "TargetDetected",
    ...
    public static readonly System.Type[] componentTypes = {
        ...
        typeof(Code.Gameplay.Features.Ammo.AmmoStatusVisualizerComponent),
        ...
        typeof(Code.Gameplay.Features.Enemy.Systems.AmmoPatternSpawnRequestSetting),
        typeof(Code.Gameplay.Features.Enemy.Systems.EnemySpawnRequestSetting),
        ...
        typeof(Code.Gameplay.Features.Enemy.Systems.SpawnRequestSettingTypeIdComponent),
