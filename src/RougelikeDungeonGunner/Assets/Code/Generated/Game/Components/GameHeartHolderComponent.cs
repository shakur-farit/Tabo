...
public partial class GameEntity {
    ...
    public Code.Meta.UI.Hud.HeartHolder.Behaviours.HeartHolder HeartHolder { get { return heartHolder.Value; } }
    public bool hasHeartHolder { get { return HasComponent(GameComponentsLookup.HeartHolder); } }

    public GameEntity AddHeartHolder(Code.Meta.UI.Hud.HeartHolder.Behaviours.HeartHolder newValue) {
    ...
    public GameEntity ReplaceHeartHolder(Code.Meta.UI.Hud.HeartHolder.Behaviours.HeartHolder newValue) {
        var index = GameComponentsLookup.HeartHolder;
        var component = (Code.Gameplay.Features.Hero.HeartHolderComponent)CreateComponent(index, typeof(Code.Gameplay.Features.Hero.HeartHolderComponent));
        component.Value = newValue;
