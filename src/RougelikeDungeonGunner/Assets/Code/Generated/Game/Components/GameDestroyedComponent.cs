...
public partial class GameEntity {
    ...
    static readonly Code.Gameplay.Features.Destroyable.Behaviours.Destroyed destroyedComponent = new Code.Gameplay.Features.Destroyable.Behaviours.Destroyed();
